...
import StatTrendChart, {
  STAT_TREND_COLORS,
} from '../components/StatTrendChart';
    ...
    return (
      <div className="px-4 pt-6 pb-28 space-y-4">
        ...
        <div className="bg-bg-card border border-border rounded-lg p-6 text-center space-y-3">
          ...
          <div className="text-purple-light text-sm font-mono font-bold">
            아직 기록이 없어요
          </div>
          ...
          {chartData.length > 0 && (
            <div className="bg-bg-card border border-border rounded-lg p-4 space-y-3">
              ...
              <div className="flex gap-3 text-[10px] font-mono text-text-sub">
                <span>
                  <span style={{ color: STAT_TREND_COLORS.hp }}>━</span> 체력
                </span>
                <span>
                  <span style={{ color: STAT_TREND_COLORS.focus }}>━</span>{' '}
                  집중력
                </span>
                <span>
                  <span style={{ color: STAT_TREND_COLORS.wallet }}>━</span>{' '}
                  지갑
                </span>
              </div>
